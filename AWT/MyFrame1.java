...
//b2.setBounds(80,200,80,30);// setting button position for b1 you can set remaining
add(b1);
add(b3);add(b2);add(b4);
//setLayout(null);
...
//difference
//setLayout( new GridLayout(2,4));// change this without any value or putting different row and column values as (2,4),(4,2) etc
//setLayout(new GridBagLayout() );/*Run the program with red colour statements, observe the result. After remove it and put the
